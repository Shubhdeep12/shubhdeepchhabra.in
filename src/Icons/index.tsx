...
export const JestIcon = ({ width = 24, height = 24, color = 'currentColor', className = '' }: IconProps) => (
	<svg viewBox='0 0 24 24' width={width} height={height} role='presentation'>
		<path
...
export const ReduxIcon = ({ width = 24, height = 24, color = 'currentColor', className = '' }: IconProps) => (
	<svg viewBox='0 0 24 24' width={width} height={height} role='presentation'>
		<path
...
export const ViteIcon = ({ width = 24, height = 24, color = 'currentColor', className = '' }: IconProps) => (
	<svg viewBox='0 0 24 24' width={width} height={height} role='presentation'>
		<path
...
export const ESlintIcon = ({ width = 24, height = 24, color = 'currentColor', className = '' }: IconProps) => (
	<svg viewBox='0 0 24 24' width={width} height={height} role='presentation'>
		<path
...
export const WebpackIcon = ({ width = 24, height = 24, color = 'currentColor', className = '' }: IconProps) => (
	<svg viewBox='0 0 24 24' width={width} height={height} role='presentation'>
		<path
...
export const GDriveIcon = ({ width = 24, height = 24 }: IconProps) => (
	<svg viewBox='0 0 32 32' width={width} height={height} role='presentation'>
		<path
