...
description: 'Learn how to integrate Razorpay in React Learn how to integrate Razorpay in React Learn how to integrate Razorpay in React Learn how to integrate Razorpay in React'
cover: 'https://cdn-images-1.medium.com/max/1000/1*MhCqLr0IGyVrAKaR_DtaJQ.png'
color: 'purple'
---

Razorpay Integration with Reactjs and Node.js
...
**Step 1:**  
Create an account on Razorpay here — [Razorpay Dashboard](https://dashboard.razorpay.com/) and get your **_Key Id_** and **_Key Secret._** You will get them in Settings -> API keys.
...
![](https://cdn-images-1.medium.com/max/1000/1*Sr1d7aSD7OUI32bd5kpjFA.png)
...
<div>
	<button onClick={() => handleCreateOrder(100, 'USD')}>Place Order</button>
...
![](https://cdn-images-1.medium.com/max/1000/1*sWY28QE8fkjFXnQDTQ_lMQ.png)
...
If you are reading this blog till here then do follow me on Twitter — [@ShubhInTech](https://twitter.com/ShubhInTech)
