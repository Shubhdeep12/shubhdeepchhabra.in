---
title: 'Connect Database with Node.js, Part 1: MongoDB using Mongoose'
publishedAt: '2023-07-03'
description: 'A short tutorial on how to connect MongoDB using Mongoose in Node.js. Discussing how to connect and how to create schema and use in in API logic.'
