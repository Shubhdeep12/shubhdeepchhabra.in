...
publishedAt: 'February 4, 2023'
description: 'Organizing your Next.js application and using components.'
cover: 'https://cdn-images-1.medium.com/max/1000/1*kUzEBuj0NTTNER_1hUt5Ag.png'
color: 'orange'
---
...
- I hope you have already developed a Next.js app before reading this.  
  If not, visit this page 👉 [https://nextjs.org/docs/getting-started](https://nextjs.org/docs/getting-started)
