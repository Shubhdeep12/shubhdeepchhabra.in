...
Ok let's start with the example, I'm skipping the step where I configured Sentry with my portfolio. If you wanna see that, you can refer to this [blog](https://okshubh.in/blog/sentry-for-nextjs-portfolio)
