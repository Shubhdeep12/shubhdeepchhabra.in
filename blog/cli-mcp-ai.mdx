...
One more thing: I’m building a CLI for [Resend](https://resend.com) so you can send emails from the terminal. If that’s useful to you, check out [@shubhdeep12/resend-cli](https://www.npmjs.com/package/@shubhdeep12/resend-cli) on npm.
